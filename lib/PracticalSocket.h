// from http://cs.baylor.edu/~donahoo/practical/CSockets/practical/
/*
...
#include <cstdlib>            // For atoi(), among others
...
public:
    /**
     *   Construct a TCP socket for use with a server, but don't start listening
